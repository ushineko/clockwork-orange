...
flake8 . --count --exit-zero --max-complexity=10 --max-line-length=127 --ignore=F541,W291,W293,E501,E203,W503,W504,E128,E129,E226,E302,E402 --exclude=pkg,venv,.git,__pycache__,build,dist --statistics
