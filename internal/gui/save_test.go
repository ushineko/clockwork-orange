...
func TestSettingsFormShowsDefaultsForAbsentKeys(t *testing.T) {
	...
	require.Equal(t, float32(10), consoleSize(u.doc), "console_font_size defaults to the Python's 10")
	require.Equal(t, "", consoleFamily(u.doc), `"Monospace" is not an installed family: Fyne's monospace face`)
